...
const IncomeVsExpenseChart = lazy(() => import('@/components/charts/IncomeVsExpenseChart'));
...
const Dashboard = () => {
  ...
  const stats = useMemo(() => {
    ...
    const totalExpenses = data.categoryExpenses.reduce((sum, item) => sum + item.amount, 0);
    const savingsRate = data.incomeVsExpense.income > 0 
      ? ((data.incomeVsExpense.income - data.incomeVsExpense.expenses) / data.incomeVsExpense.income * 100).toFixed(1)
      : 0;
      ...
      <main className="container mx-auto p-6">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4 mb-8">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold text-success">${data.incomeVsExpense.income.toLocaleString()}</div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold text-warning">${stats?.totalExpenses.toLocaleString()}</div>
              <p className="text-xs text-muted-foreground mt-1">This period</p>
            </CardContent>
          </Card>
